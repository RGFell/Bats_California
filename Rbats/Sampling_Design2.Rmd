...
head(valuetable2) 
summary(valuetable2)
km1 <- kmeans(na.omit(valuetable2), centers = 5, iter.max = 100, nstart = 10)
...
valuetable2$class[rNA==0] <- km1$cluster
...
```{r}
model1 <- colext(~v.1+v.2+v.3, ~1, ~1, ~1, umf)

model2 <- colext(~1, ~1, ~1, ~1, umf)

model3 <- colext(~v.1+v.2, ~1, ~1, ~1, umf) #this should be the best model
model1
model2
model3
