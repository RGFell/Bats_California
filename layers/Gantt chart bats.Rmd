...
**Spatial design:** Ongoing, the work done so far can be found [here](http://rpubs.com/derek_corcoran/bats_california), the first sampling design draft will be available on friday the 1st of may. For more information and scripts go [here](https://github.com/derek-corcoran-barrios/Bats_California)
